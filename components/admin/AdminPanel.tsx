...
export function AdminPanel({
  ...
  const role = (!authLoading && user?.role) || initialRole;
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="min-w-0 px-4 py-8 md:ml-56 md:px-10 ">
        ...
        {activeSection === "exchanges" && canAccessAdminSection(role, "exchanges") && (
          <section>
            <ExchangeManager />
          </section>
        )}

        {activeSection === "sections" && canAccessAdminSection(role, "sections") && (
          <section>
        ...
        {activeSection === "categories" && canAccessAdminSection(role, "categories") && (
          <section>
            <h2 className="text-lg font-medium text-stone-900 mb-4">
              Categorias da loja
            </h2>
        ...
        {activeSection === "banner" && canAccessAdminSection(role, "banner") && (
          <section>
            <h2 className="text-lg font-medium text-stone-900 mb-4">
        ...
        {activeSection === "settings" && canAccessAdminSection(role, "settings") && (
          <section>
        ...
        {activeSection === "users" && canAccessAdminSection(role, "users") && (
          <section>
            <UsersManager />
          </section>
        )}
