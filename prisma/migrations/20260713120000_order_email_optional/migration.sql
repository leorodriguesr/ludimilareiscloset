-- SQLite/Turso: recreate Order making email nullable (without local-only drift columns).
...
INSERT INTO "new_Order" (
    ...
    "customerDataStatus",
    "customerDataToken",
    "customerDataTokenExpiresAt",
    "paymentChannel",
    "manualPaidByUserId",
    "deliveryNotes",
    "internalNotes",
    "arrangedShippedAt",
    "arrangedShippedByUserId",
    "subtotalOriginal",
    "itemsDiscountTotal",
    "orderDiscountMode",
    "orderDiscountValue",
